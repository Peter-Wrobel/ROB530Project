...
%                 obj.particles(:,j) = obj.gfun(obj.particles(:,j),u_noise_std*randn(3,1)+u);
                ...
                z_hat_1 = obj.hfun(landmark_x, landmark_y, obj.particles(:,j));
                z_hat_2 = obj.hfun(landmark_x2, landmark_y2, obj.particles(:,j));
                diff = [...
                ...
                %measurement
                weight(j) = mvnpdf(diff, 0, blkdiag(obj.Q,obj.Q));
            end
            %Update Weights
